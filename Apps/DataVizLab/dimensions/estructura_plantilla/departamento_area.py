...
def by_departamento_area(request, pk):
    ...
    # total de personas por departamento/área
    total_people = gender_counts.sum(axis=1)

    # porcentaje horizontal de hombres y mujeres
    ...
    # porcentaje vertical de hombres y mujeres
    ...
    # mostrar todas las filas y columnas en la salida por consola
